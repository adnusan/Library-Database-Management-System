...
-- -----------------------------------------------------
-- CHANGES MADE
-- added dob in user table
-- added due date in borrows table
-- Added amount in invoice table
-------------------------------------------------------
-- Schema LibraryManagementDB
-- -----------------------------------------------------
DROP DATABASE IF EXISTS LibraryManagementDB; -- dropping db with same name
